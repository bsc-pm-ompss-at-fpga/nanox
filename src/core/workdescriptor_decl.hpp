...
namespace nanos
{
   ...
   class Device
   {
      ...
      public:
         ...
         virtual void *memAllocate( std::size_t size, SeparateMemoryAddressSpace &mem, uint64_t targetHostAddr = 0 ) { return (void *) 0xdeadbeef; }
         virtual void memFree( uint64_t addr, SeparateMemoryAddressSpace &mem ) {  std::cerr << "wrong memFree" <<std::endl; }
